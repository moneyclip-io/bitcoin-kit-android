...
object TransactionExtractorTest : Spek({
    ...
    beforeEachTest {
        ...
        fullTransaction =
            FullTransaction(Transaction(), listOf(transactionInput), listOf(transactionOutput))
        ...
        extractor = TransactionExtractor(
            ...
            metadataExtractor = TransactionMetadataExtractor(transactionOutputsCache, TransactionOutputProvider(storage))
        )
    }
    ...
    describe("#extract") {
        ...
        it("extractP2PKH") {
            ...
            assertEquals(
                "37a9bfe84d9e4883ace248509bbf14c9d72af017",
                fullTransaction.outputs[0].keyHash?.toHexString()
            )
            assertEquals(
                "37a9bfe84d9e4883ace248509bbf14c9d72af017",
                fullTransaction.outputs[1].keyHash?.toHexString()
            )
        ...
        it("extractP2SH") {
            ...
            assertEquals(
                "cdfb2eb01489e9fe8bd9b878ce4a7084dd887764",
                fullTransaction.outputs[0].keyHash?.toHexString()
            )
            assertEquals(
                "aed6f804c63da80800892f8fd4cdbad0d3ad6d12",
                fullTransaction.outputs[1].keyHash?.toHexString()
            )
